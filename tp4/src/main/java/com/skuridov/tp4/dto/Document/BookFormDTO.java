...
@Data
@NoArgsConstructor
public class BookFormDTO extends DocumentFormDTO {
    private String author;
    private String editor;
    private int pageAmount;
    private String genre;

    public BookFormDTO(String id, String title, int publicationYear, String language, int nbCopies, String author, String editor, int pageAmount, String genre) {
